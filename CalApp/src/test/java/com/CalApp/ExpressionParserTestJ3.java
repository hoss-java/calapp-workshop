 ...
 */
public class ExpressionParserTestJ3
    extends TestCase
{
    /**
     ...
     */
    public ExpressionParserTestJ3( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( ExpressionParserTestJ3.class );
    }
    ...
    public void testEvaluate(){
        ...
        assertEquals("expected 14.0 but was " + result, result, 1e-9);
    }
}
